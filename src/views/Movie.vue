      ...
      <div class="info">
        <div class="main-info">
          ...
          <div class="entry-meta-info">
            ...
            <span>{{convertRuntime(entry.runtime)}}</span>
          </div>
        ...
        <div class="production-info">
          <div class="production-talent">
            <div class="crew-list">
              <p class="crew-header">Director</p>
              <span v-for="worker in directors" :key="worker">{{worker}}</span>
            </div>
            <div class="crew-list">
              <p class="crew-header">Producer</p>
              <span v-for="worker in producers" :key="worker">{{worker}}</span>
            </div>
            <div class="crew-list">
              <p class="crew-header">Writer</p>
              <span v-for="worker in writers" :key="worker">{{worker}}</span>
            </div>
          </div>
          <div class="studios">
